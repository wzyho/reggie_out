...
public class DishController {
     ...
     */
    @PutMapping
    public R<String> updateWithFlor(@RequestBody DishDto dishDto){

        dishService.updateWithFlor(dishDto);
     ...
     */
    @DeleteMapping("/{ids}")
    public R<String> deleteDish(@PathVariable List<Long> ids){
        dishService.bulkDeletion(ids);
